...
public class ShooterIOTalonFX implements ShooterIO {
    ...
    public ShooterIOTalonFX(){
        ...
        rollerMotor1LinearVelocity = MetersPerSecond.of(circumference.magnitude() * rollerMotor1AngularVelocity.getValue().magnitude());

        rollerMotor1LinearAcceleration = MetersPerSecondPerSecond.of(circumference.magnitude() * rollerMotor1AngularAcceleration.getValue().magnitude());
        ...
        rollerMotor2LinearVelocity = MetersPerSecond.of(circumference.magnitude() * rollerMotor2AngularVelocity.getValue().magnitude());
        rollerMotor2LinearAcceleration = MetersPerSecondPerSecond.of(circumference.magnitude() * rollerMotor2AngularAcceleration.getValue().magnitude());
    ...
    public void updateInputs(ShooterIOInputs inputs) {
        ...
        BaseStatusSignal.refreshAll(rollerMotor1Angle, rollerMotor1AngularVelocity, rollerMotor1AngularAcceleration, rollerMotor1Temperature, rollerMotor1Voltage, rollerMotor1Current);

        BaseStatusSignal.refreshAll(rollerMotor2Angle, rollerMotor2AngularVelocity, rollerMotor2AngularAcceleration, rollerMotor2Temperature, rollerMotor2Voltage, rollerMotor2Current);

        inputs.rollerMotor1Angle = Rotation2d.fromRadians(rollerMotor1.getTalonFX().getPosition().getValue().magnitude());
        ...
        inputs.rollerMotor2Angle = Rotation2d.fromRadians(rollerMotor2.getTalonFX().getPosition().getValue().magnitude());
    ...
    @Override
    public void resetRoller1(Rotation2d
     resetAngle) {
